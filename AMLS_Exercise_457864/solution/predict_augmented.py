"""Run Task 1.3 inference on the runtime predict split."""
...
def main() -> None:
    """Load the robust model and write Task 1.3 predictions."""
    args = parse_args()
    ...
    output_path = solution_dir / "artifacts" / "task03" / "predictions.csv"

    checkpoint = torch.load(model_path, map_location="cpu", weights_only=False)
    if checkpoint.get("threshold") is None:
        raise ValueError("The Task 1.3 model checkpoint has no calibrated threshold")
